## **html2canvas html截图插件图片放大清晰度解决方案，支持任意放大倍数，解决原插件图片偏移问题** {#articleHeader0}

Author:youzebin \(2016.12.6\)  
插件下载地址：[https://github.com/niklasvh/h...](https://github.com/niklasvh/html2canvas)
...
## 运行上面的demo 前有以下**注意点**： {#articleHeader2}
